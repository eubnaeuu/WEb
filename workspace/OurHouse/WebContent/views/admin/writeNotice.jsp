        ...
        <div class="header--background"></div>
            ...
            <div class="inner clearfix">
                ...
                <div class="menu-group float--left">
                    ...
                    <div class="logo">
                        <a href="/admin/memberList.do">우리의집</a>
                    </div>
            ...
            <div class="dashboard-contents">
                ...
                <div class="write-container">
					...
					<form id="insertNotice" method="post">
	                    ...
	                    <input class="input--text" name="notice_title" id="noticeTitle" type="text" placeholder="게시글 제목" onchange="chkTitle()">
						<span id="checkTitle"></span>
	                    <input type="hidden" id="checkTitle">
	                    
	                    <textarea class="input--text" name="notice_content" id="noticeContent" placeholder="게시글 내용" onchange="chkContent()"></textarea>
						<span name="checkContent"></span>
						<input type="hidden" id="checkContent">
	                    
	                    <input class="btn" type="button" value="게시글 작성" onclick="addNotice()">
