        ...
        <div class="inner">
            ...
            <nav class="nav-container">
                <ul class="nav-list">
                    ...
                    <li class="nav-item"><a href="memberManage.html">회원관리</a></li>
                    <li class="nav-item" style="color: #35C5F0;"><a href="/admin/noticeList.do">공지사항</a></li>
                    <li class="nav-item">쿠폰관리</li>
                </ul>
            </nav>
            ...
            <div class="dashboard-contents">
                ...
                <div class="write-container">
					...
					<form>
	                    ...
	                    <input class="input--text" type="text" value="<%=noticeVO.getNoticeTitle()%>" readonly="readonly">
	                    
	                    <textarea class="input--text" readonly="readonly"><%=noticeVO.getNoticeContent() %></textarea>
					</form>
