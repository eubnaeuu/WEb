...
<div class="body__container"> <!-- body의 일부분인 컨테이너임을 의미 -->
    ...
    <section class="section section-login">
        <!-- 콘텐츠가 들어가는 inner영역 -->
        <div class="inner">
            <a href="/main.do" class="login-logo"></a>

            <form action="" class="signin" id="signinForm">

            <div class="signform">
                    <input class="input--text text--id" type="text" name="memId" id="memId" placeholder="아이디" maxlength="12"> 
                    <input class="input--text text--pw" type="password" name="memPass" id="memPass" placeholder="비밀번호" maxlength="12">
            </div>

            <input type="button" class="btn" onclick="signin()" value="로그인">
            <a href="<%=request.getContextPath()%>/member/signup.do" class="btn" >회원가입</a>

            </form>

            <div class="reset">
                <a href="<%=request.getContextPath()%>/member/findId.do">아이디 찾기💬</a>
