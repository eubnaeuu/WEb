...
<%
	...
	List<FollowVO> followerList = (List<FollowVO>) request.getAttribute("followerList");
	List<FollowImgVO> followerImgList = (List<FollowImgVO>) request.getAttribute("followerImg");
	System.out.println("jsp임");
    ...
    <section class="section section--follow">
        <div class="inner">
            ...
            <div class="follow--conatiner">
                <ul class="user--list">
                    <li onclick="location='/member/user.do?memId=<%=followerImgList.get(i).getMemId()%>'"><!-- onclick에 회원 프로필로 -->
                        <div class="userImg">
                        	<%if(!(followerImgList.get(i).getProfileImg() == null)) { %>
                            <img src="/image/uploads/<%=followerImgList.get(i).getProfileImg() %>" alt="">
                            <%} else { %>
                            <img src="../../image/uploads/default_profile.png" alt="">
                            <%} %>
                        </div>

                        <a class="userNick"><%=followerImgList.get(i).getMemId() %></a>
                    </li>
                </ul>
            </div>
					<%} %>
