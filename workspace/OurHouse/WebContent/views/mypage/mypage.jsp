...
<head>
    ...
    function loginCheck(){
		<%if(m == null){%> //세션에서 가져온 vo들이 null일때
             //로그인페이지로
             alert("로그인 후 이용해주세요");
...
<div class="body__container">
    ...
    <header class="section section-profile-subnav">
        <div class="inner">
            <ul>
                <li style="border-bottom:4px solid #35C5F0"><a style="color:#35C5F0" href="/member/mypage.do">모두보기</a></li>
                <li><a href="#" onclick="showMemPhoto('<%=memId %>')">사진</a></li>
                <li><a href="#" onclick="showMemQnA('<%=memId %>')">질문과답변</a></li>
                <li><a href="#" onclick="showMemLike('<%=memId %>')">좋아요</a></li>
                <li><a href="#" onclick="addCoupon('<%=memId %>')">내 쿠폰</a></li>
                        ...
                        <div class="user-profile_links">
                            <ul class="links">
                                ...
                                <li>
                                    ...
                                    <span class="links-title"><a href="#" onclick="showMemLike('<%=memId %>')">좋아요</a></span>
                                    <span class="links-state"><%=likesCnt %></span>
                                </li>

                                <li>
                                    <i class="far fa-credit-card"></i>
                                    <span class="links-title"><a href="#" onclick="addCoupon('<%=memId %>')">내 쿠폰</a></span>
                ...
                <div class="picturecontainer">
                    ...
                    <div class="picturetitle">
                        ...
                        <div class="allView" id="memPhoto">
                           <a href="#"  onclick="showMemPhoto('<%=memId %>')">전체보기</a> 
